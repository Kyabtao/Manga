...
| **Chapter in progress** | **Chapter 009 *The Reading* — pages 001–006 scripted (EN); the chain-stop is SPENT (p006)** · Chapters 001–008 COMPLETE · **Hindi: Ch. 001–008 COMPLETE** (94.4–98.1% Devanagari) |
| **Pages completed** | Ch. 001–008: **all complete** (80 pages, 80 images) · Ch. 009: 6 of 10 scripted |
| **NEXT page to build** | **Chapter 009 · Page 007** — the blank at the top of the identification form; Jadi's three days |
