...
| **Chapter in progress** | **Chapter 009 *The Reading* — all 10 pages scripted (EN); chain-stop SPENT (p006)** · Chapters 001–008 COMPLETE · **Hindi: Ch. 001–008 COMPLETE** (94.4–98.1% Devanagari) |
| **Pages completed** | Ch. 001–008: **all complete** (80 pages, 80 images) · Ch. 009: **10 of 10 scripted (EN)** |
| **NEXT page to build** | **Chapter 009 Hindi pass (pages 001–010)** — then Chapter 010: *the walk up the Council Stair* |
