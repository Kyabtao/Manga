...
| **NEXT art to fix** | **Audit run 10: three pages fail their own scripts** — `ch005/p004` (wrong beats: a lava cave and a glowing gem against *The First Pull* at the counter), `ch003/p010` (landscape + invented content), `ch006/p010` (landscape, chain panel missing). Prompts written in `AUDIT.md` run 10 §8. Then finish the rebuild: Ch. 001 p006–010, then Ch. 002–005. **The checklist is the page-art QA gate in `series-bible/style-guide.md`** (shape · panel count · beats · props · canon markers). |
