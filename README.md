...
| **NEXT art to fix** | **Ch. 001 rebuilt 001–010 (verified), and Ch. 002 pages 001–004 rebuilt and verified this turn.** **Next: `ch002/p005`–`p006`** — both prompts are written and both v1 renders were rejected (p005's art had the prompt text rendered inside a panel; p006 came back landscape). Then Ch. 002 p007–p010, Ch. 003 p001–p009, Ch. 004 and Ch. 005 — **34 pages**, running ~4–6 accepted renders a turn at the reject rate §8c records. **Landscape page art in the repo is zero. Checklist: the page-art QA gate in `series-bible/style-guide.md`** (shape · panel count · beats · props · canon markers). |
