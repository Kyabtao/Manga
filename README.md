...
| **NEXT art to fix** | **Ch. 001 is fully rebuilt — pages 001–010, all portrait 768 × 1376, each verified against its own script** (run 10 §8b; the three run-10 defect pages — `ch005/p004`, `ch003/p010`, `ch006/p010` — were regenerated and verified first). **Landscape page art in the repo is zero.** Next: **Ch. 002–005** (old pass, ratios to 8.3), then the §3 sample over the remaining 91 pages. **Checklist: the page-art QA gate in `series-bible/style-guide.md`** (shape · panel count · beats · props · canon markers). |
