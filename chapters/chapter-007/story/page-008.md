...
## PANEL 1 — Medium, the back wall (~13%)

**Camera:** The archive's back wall, third morning. The oldest Kshudra files in the building —
...
**Image:** The back wall, and the shape of a missing thing. Ira's hand is already on the shelf
...
## PANEL 2 — Close, the dust outline (~14%)

**Camera:** Macro on the shelf. Clean board, except for one rectangle of softer, darker board
...
**Image:** The file was pulled, not carried. A mender reads it in a second, and so should the
reader.
...
## PANEL 3 — Close, the shelf label (~14%)

**Camera:** Close on the shelf's lip, where every file on the back wall has its name sewn on in
...
**Image:** Knot-script, close. A label that stays when its file leaves. This is the series'
...
## PANEL 4 — Large, Nandi reads the label (~15%)

**Camera:** Nandi's gnarled hands turning the knotted label over. She reads it flat, without
ceremony, and her voice is the voice of a woman reading a shelf number she has read ten thousand
times — because she has.

**Image:** The old Kshudra reading her own archive's oldest label aloud, to the one person in
...
**Camera:** Ira, close, working it. Not shock — arithmetic. Her eyes moving slightly, the way they
moved on Page 002 when she read clause four.

**Image:** The mender adding up what a list of pupils is worth.
...
## PANEL 6 — Medium, Nandi says the thing (~14%)

**Camera:** Nandi, and for the first time in the series, she will not meet Ira's eyes. She looks
at the empty shelf instead. Her hands are flat on her knees.

**Image:** An archive keeper declining to disclose. She is not protecting a principle; she is
...
## PANEL 7 — Close, the two names — CLOSING HOOK (~16%)

**Camera:** Ira, alone in frame, the empty shelf behind her. One hand holds the principal's letter.
The other is open, palm up, stitch in it. She is looking at the gap.

**Image:** A girl holding two pieces of paper about herself — one that names her and one that used
