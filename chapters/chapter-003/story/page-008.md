...
**Page type:** The census opens — 7 panels, hook at the bottom

> Beats carried from Page 007: the stitch's first movement, the echo explanation, the oath-link
> unread. Page 005: the three threads as a family photograph. Page 001: the posting order.

---

## PANEL 1 — Wide, the afternoon appraisal (~14%)

**Camera:** Afternoon, Knot & Nail: no customers. Kessa sits behind the counter, loupe down, the
...
**Image:** Kessa reading the census the way she reads debt-marks: line by line, no expression,
...
## PANEL 2 — Macro, the cross-out (~13%)

**Camera:** Extreme close on the census's foot: the name *Ira Sutar*, crossed out in crimson — dry,
no initial, the mark that initialled itself overnight (Ch. 002 Page 004). Kessa's loupe hovers
over the cross-out.

**Image:** The crimson cross-out is dry, old now, but its meaning has changed. What was once a
...
> **KESSA (dialogue, to the cross-out):**
> You counted her. Then you crossed her out. That's not a correction. That's a signature.

---

## PANEL 3 — Medium, the interpretation (~14%)

**Camera:** Kessa's hands on the census, spreading it flat. Her loupe moves from the crimson
cross-out to the grey names above it. The grey names are witnesses; the crimson name is something
else.

**Image:** The census as a document with two layers: grey (Council procedure) and crimson (the
...
## PANEL 4 — Close, the stitch responds (~13%)

**Camera:** Ira across the counter, hand on the census beside Kessa's. Her palm-stitch catches
...
**Image:** The stitch and the crimson cross-out in the same frame: two marks about the same girl,
...
## PANEL 5 — Medium, the lockbox grows (~14%)

**Camera:** Kessa folds the census and returns it to the box: four objects now. Her hands are
...
**Image:** The four objects in the open box: cut-end (thread), census (paper), posting order
...
## PANEL 6 — Wide, the evening row (~13%)

**Camera:** Evening: the stall-row quietens. The Knot & Nail stays open — Kessa has not closed
...
**Image:** The basin at dusk, the Knot & Nail as its centre of gravity. The inch-closer is
...
## PANEL 7 — Macro, the box — HOOK (~19%)

**Camera:** Night: the lockbox on the counter, lid closed, Kessa's hand resting on it. From
...
**Image:** The box is closed and the thread inside it moves. No one opens the lid. No one touches
the box. The thread moves on its own — or responds to something in the room, or in the basin,
or in the air.

> **SFX:** (inside the box, faint) *—*
>
> **CAPTION (none spoken):**
