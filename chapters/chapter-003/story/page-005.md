...
**Sector:** Agnikhand — Ashfall Basin, dawn
**Page type:** The cutter comes — 7 panels, hook at the bottom

> Beats carried from Page 004: the supply line, the second piece of thread, Kessa's tally-knot.
> Page 003: Bhan's arm left readable, the charcoal mark.

---

## PANEL 1 — Wide, dawn at the dock (~14%)

**Camera:** Dawn, dock three: Bhan asleep against a grain-lift, left sleeve rolled up, forearm
...
**Image:** Bhan sleeping, patient even in rest. His arm is a canvas waiting. The dock lamp flickers.
...
## PANEL 2 — Medium, the figure arrives (~13%)

**Camera:** A figure at the dock's edge, hooded, small — not a large person. The shadow falls
...
**Image:** The cutter: hooded, careful, moving the way Kessa moves — unhurried, final. The
ash-grey thread is visible on the gloved finger. The cutter's hands are steady and surgical.

> **SFX:** (soft, thread through skin) *tsss*

---

## PANEL 3 — Macro, the cut (~14%)

**Camera:** Extreme close on Bhan's forearm as the cutter works: the nightly reopening, the
...
**Image:** The cutter reads the mark. The mark says: *someone was here before you.* The cutter's
...
## PANEL 4 — Close, the response (~13%)

**Camera:** The cutter's hand, still on the charcoal mark. A new gesture: the cutter takes a
...
**Image:** The second thread is identical to the cut-end in Kessa's box. The cutter is not
...
**Camera:** The cutter stands, rolls Bhan's sleeve down — careful, gentle, the way you close a book
...
**Image:** The cutter's departure is unhurried. The hood's angle toward the list-post is the hook's
...
## PANEL 6 — Medium, morning at the stall (~13%)

**Camera:** Morning, Knot & Nail: Ira arrives to find Kessa already behind the counter, loupe
...
**Image:** A third piece of ash-grey thread on the counter. Not the cut-end (that's in the box).
...
>
> **KESSA (dialogue):**
> Same thread. Same gauge. A gift, or a receipt.

---

## PANEL 7 — Macro, the three pieces — HOOK (~19%)

**Camera:** The counter, flat: the cut-end from the box, the thread from the counter, and — laid
...
**Image:** Three pieces of thread, side by side. A family photograph of the supply line.

> **KESSA (dialogue, quiet):**
> Box. Counter. Yours. Same thread.
>
> **KESSA (dialogue, quieter):**
