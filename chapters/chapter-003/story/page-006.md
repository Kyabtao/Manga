...
**Sector:** Agnikhand — Ashfall Basin, the Knot & Nail (mid-morning)
**Page type:** The basin's reaction — 7 panels, hook at the bottom

> Beats carried from Page 005: the three threads on the counter, the cutter's nightly visit to
> Bhan, the charcoal mark kept. Page 002: the lockbox holds three objects, Kessa refused to sign.

---

## PANEL 1 — Wide, the basin at the stall (~14%)

**Camera:** Mid-morning, Knot & Nail: a small queue has formed — not for mending, for *filing*.
...
**Image:** The posting order's consequence: the basin has heard that the Knot & Nail now holds
...
## PANEL 2 — Medium, the first request (~13%)

**Camera:** A stall-owner (unnamed, broad, nervous) holds out a torn rent-chit — the kind the
Council issues and the basin fears. He wants it in Kessa's box because the box now holds the
census, and the census is safe.

**Image:** Kessa's hand is flat on the counter, palm down: *no.* Her loupe is up. She is not
appraising; she is refusing.

> **STALL-OWNER (dialogue, nervous):**
...
## PANEL 3 — Close, the queue grows (~13%)

**Camera:** The queue from Kessa's perspective: faces she has known for years, all carrying
...
**Image:** The queue is quiet and dignified and afraid. Kessa sees each face the way she sees
...
## PANEL 4 — Medium, the three threads (~14%)

**Camera:** The counter's corner: the three threads still laid out from Page 005 — cut-end,
...
**Image:** The three threads as the page's anchor: same colour, same gauge, three ages. Ira's
fingers trace the counter-gift — the fresh one, left overnight.

> **IRA (dialogue, to the thread):**
> This one was left while we slept. On a counter that faces the whole row. Nobody saw.
>
> **KESSA (dialogue, from the queue):**
> Nobody ever sees thread-work. That's why it's thread-work.

---

## PANEL 5 — Wide, the afternoon (~13%)

**Camera:** Afternoon: the queue is gone. Kessa sits alone at the counter, the lockbox closed,
...
**Image:** Kessa's tally-thread is heavier than yesterday. The lockbox is heavier than yesterday.
...
## PANEL 6 — Medium, Rekhak passes (~13%)

**Camera:** Through the market, without stopping: Rekhak Vahni walks the row on his rounds as
...
**Image:** Rekhak in motion, not stopping, not looking. The chain's hum is the only event. One note
...
## PANEL 7 — Close, the note — HOOK (~19%)

**Camera:** On Ira's face, eyes tracking Rekhak's retreating form. The note from the chain hangs
...
**Image:** Ira's eyes widen. Not shock — recognition. The four notes are in the chain's hum, but
