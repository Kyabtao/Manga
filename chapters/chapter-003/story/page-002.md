...
**Chapter title:** *The Hand That Opens* / *वह हाथ जो खोलता है*
**Arc:** I — The Unspooling
**Sector:** Agnikhand — Ashfall Basin, the Knot & Nail (counter, mid-morning)
**Page type:** Procedure arrives — 7 panels, hook at the bottom

> Beats carried from Page 001: the reversal ("the cutter taught your stitch"), the posting order
...
**Camera:** Mid-morning, Knot & Nail: the posting order lies open on the counter between Kessa and
...
**Image:** The stall at rest after the revelation. Ira's kit is closed. Kessa's loupe is up. The
...
## PANEL 2 — Medium, the arrival (~13%)

**Camera:** The Council Stair's base, visible from the stall-row: a tall thin figure descending,
...
**Image:** Rekhak descends with procedure's posture — not hunting, not threatening, *filing*. He
...
> **CAPTION (none spoken):**
> Procedure has two speeds: it files, or it waits. Today it walks.

---

## PANEL 3 — Medium two-shot, the counter (~14%)

**Camera:** From behind Rekhak's shoulder, looking at Kessa behind the counter. Ira stands to
Kessa's left, slightly behind — witness position, the same stance as Page 001. The posting order
lies between them.

**Image:** Kessa's loupe is **up**: she is not appraising, she is receiving. Her hands are flat on
...
> **REKHAK (dialogue, formal):**
> The census requires a custodian of record. The posting names this stall.
>
> **KESSA (dialogue, dry):**
...
## PANEL 4 — Close, the slate (~13%)

**Camera:** Macro on the slate Rekhak has brought: grey Council columns, three signature lines —
...
**Image:** The slate's columns are clean, the handwriting official. The crimson line is dry,
...
## PANEL 5 — Medium, the refusal (~14%)

**Camera:** Kessa's hands on the counter, not touching the slate. One hand turns the posting order
...
**Image:** Kessa does not look at Rekhak. She looks at the blank line the way she looks at a tear
she has already appraised and chosen not to mend.

> **KESSA (dialogue, flat):**
> I keep what's in the box. I don't sign for why it's there.
>
> **REKHAK (dialogue, measured):**
> The signature acknowledges custody, not content.
>
> **KESSA (dialogue):**
> Then the box acknowledges nothing and we're all filed.

---

## PANEL 6 — Close, the oath-link (~13%)

**Camera:** On Rekhak's hand holding the chain, the oath-link in frame — one dark link among the
brass, still, readable. His thumb rests beside it, not on it. Ira's eyes, in soft focus at frame
edge, are on the link.

**Image:** The oath-link is the smallest object on the page and the heaviest. Ira sees it. She does
not reach for it. The chain runs everywhere else; that one link stays perfectly still.

> **CAPTION (Ira's voice, small):**
> One link in his chain doesn't move. I know what it holds. I'm not ready to read it.

---

## PANEL 7 — Medium, the departure — HOOK (~19%)

**Camera:** Rekhak at the stall's threshold, coat turning, chain running. He does not look back.
...
>
> **KESSA (dialogue, to the box):**
> Then they'll need a bigger drawer.
>
> **CAPTION (none spoken):**
