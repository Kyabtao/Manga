...
Procedure arrives at her counter — and the lockbox keeps its dark.
```
...
The lockbox now holds two truths.
```
...
Procedure's shadow, standing in the shop.
```
