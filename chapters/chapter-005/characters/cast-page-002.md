...
Braided thread emerged — and she contained it.
```
...
The thread contained, on her word.
```
...
Descends on the whisper of a blank strand.
```
...
```
Guthli / Kshudra / Agnikhand / knotted (light) / light debt /
steam-pot rumour-carrier /
The basin whispers through her pot.
```
