...
**Sector:** Agnikhand — Ashfall Basin, the Knot & Nail (morning)
**Page type:** The decision — 7 panels, hook at bottom
...
**Camera:** Morning, Knot & Nail: Ira arrives with the kit. Kessa is behind the counter, loupe up. The
...
## PANEL 2 — Medium, the question (~13%)
**Camera:** Ira's face: the question she has held since Chapter 1. Not *who sewed me* — *who was my mother
in the Mendery, and what did she sew into me.*

> **IRA (dialogue, flat):**
> My mother was in the Mendery. The thread is braided. The Inspector knew.
>
> **IRA (dialogue):**
> I need the Mendery file.

## PANEL 3 — Close, Kessa's hands (~14%)
**Camera:** Kessa's hands: she closes the lockbox. Then she does something unexpected: she reaches under the
...
## PANEL 4 — Medium, the key (~13%)
**Camera:** The key in Kessa's hand: small, black, Kshudra-forged. Old. It has been under the counter for
...
## PANEL 5 — Close, Ira's palm (~14%)
**Camera:** Ira's palm: the mark is open, the thread is held. The braided thread responds to the key's
...
## PANEL 6 — Wide, the basin (~13%)
**Camera:** The basin: the Knot & Nail works, the market adjusts. The stall-row trusts the lock. The
...
## PANEL 7 — Macro, the key in Ira's hand — HOOK (~19%)
**Camera:** Ira's hand: the key from Kessa. Her palm is open, the mark visible, the braided thread held.
...
- **The key is the chapter's smallest object and its largest inheritance.** Kessa kept it safe and hands it over without ceremony.
- **Thread memory:** the mark recognises the key before Ira does. Give it one panel and no explanation.
