...
> the commission prose like skin. First notices the fold's lend mid-mend (Panel 6); does not stop it yet
> (Page 002's kindness-memory still covers it). The payment line makes every future mend an instalment
> on her own name.
...
> Sits on the crate edge exactly once — a broker who sits plans to return. Shadow falls toward the
...
- **Kessa** — shutters day seven, no slit; her stall's dark is the backdrop of Panels 1–4.
- **Rekhak** — off-panel with the oath-link; no chain on this page (budget closed).
- **Lekh** — cuff-chit sleeps. **Grey Clerk** — gone. **Auditors** — done for the chapter.
- **Guthli, Pira** — owned quiet; Guthli's pot-lid comes on like a door closing (Panel 1), no dialogue.

---

## Page 007 — nobody else

Three roles and a lantern: the broker who bills, the mender who terms, the dock worker who is being
farmed. The fourth presence is a cut-fray: one clean stroke, nightly, same angle, same depth.
