...
Rule three enrolls; rules one and two finish.
```
...
The school's purpose, priced at last.
```
...
```
Jadi / Kshudra / Agnikhand / grey, grown under the skin / heavy — carried forty-four years /
Roster: keep the school's count without a book /
The purpose revealed — she is the enrollment rule's proof.
```
Full sheet (Ch. 008): [`jadi.md`](jadi.md)
