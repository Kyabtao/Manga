...
Saves the records by declaring them the principal's property.
```
...
The declaration's basin witness.
```
...
```
Nandi / Manavkin / Agnikhand / grey, cut from one piece / light, paid in kind /
Read: identify any knot's kind, year and hand; cannot read a page /
The records saved — and the hole beside the book.
```
