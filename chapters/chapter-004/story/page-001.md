...
**Sector:** Agnikhand — Ashfall Basin, the Knot & Nail (morning, day after Ch. 003)
**Page type:** Chapter opening — 7 panels, hook at the bottom

> Beats carried from Chapter 003: the chain-stop confession, the five threads (supply line),
...
**Camera:** Morning, basin market: the Knot & Nail opens. Kessa behind the counter, loupe up.
...
**Image:** The first Council visit since the posting order. The Grey Clerk is different from
...
## PANEL 2 — Medium, the request (~13%)

**Camera:** The Grey Clerk at the counter, slate offered. The slate carries one line, grey ink:
a request to *inspect* the lockbox. Not seize — inspect. Procedure has learned Kessa's grammar.

**Image:** Kessa reads the slate without touching it. Her loupe is up. Her hands are in her
coats.

> **GREY CLERK (dialogue, formal):**
...
## PANEL 3 — Close, the refusal (~13%)

**Camera:** Kessa's hands: she turns the slate face-down on the counter — her grammar from
...
**Image:** The coin on the slate: Kessa's counter-offer. Not refusal — *pricing*. She will
...
## PANEL 4 — Medium, the basin watches (~14%)

**Camera:** The Grey Clerk leaves. The market exhales. Two stall-owners move another inch closer
to the Knot & Nail — the trust measurement continues. Ira arrives with her kit, seeing the
departing clerk.

**Image:** The basin's geometry: the Knot & Nail as the centre, the stalls orbiting closer.

> **IRA (dialogue, arriving):**
> What did they want?
>
> **KESSA (dialogue):**
> To look in the box.
...
## PANEL 5 — Wide, the dock approach (~13%)

**Camera:** Ira at the dock-gate, mid-morning. The chit-boy's slate shows her name: *Sutar, I.
— dock three — read.* The pre-logged line from Ch. 003 Page 003, still there.

**Image:** The slate with her name, the dock-gate lamp, the grain-lifts behind.
...
## PANEL 6 — Close, Bhan's arm (~13%)

**Camera:** Bhan's forearm: the nightly opening is there, as expected. But tonight's addition
...
**Image:** The pattern on Bhan's arm is the first direct echo of Ira's palm-stitch. The cutter
...
## PANEL 7 — Macro, the pattern — HOOK (~19%)

**Camera:** Extreme close on the pattern in Bhan's arm: the stitch-grammar of Ira's palm,
...
**Image:** The pattern is a mirror — Bhan's arm shows what Ira's palm looks like from the
