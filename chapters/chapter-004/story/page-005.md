...
**Sector:** Agnikhand — Ashfall Basin, the Knot & Nail (dawn)
**Page type:** The gift — 7 panels, hook at bottom

> Beats: Page 004 — the stitch breathes, the counter answered the box.

---

## PANEL 1 — Wide, dawn discovery (~14%)
...
> **KESSA (dialogue, dry):** Same thread. Same knot. Sixth piece.

## PANEL 2 — Macro, the whorl-knot (~13%)
...
## PANEL 3 — Medium, the lockbox grows (~14%)
...
## PANEL 4 — Close, Ira's understanding (~13%)
...
> **IRA (dialogue, flat):** One person. Forty years. The same thread.
>
> **KESSA (dialogue):** That's not a supply line, child. That's a *life's work*.

## PANEL 5 — Wide, the basin day (~13%)
...
## PANEL 7 — Macro, the stitch — HOOK (~19%)
