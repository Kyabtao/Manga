...
Carries the confession's weight into a new chapter.
```
...
The counter open on the morning after the confession.
```
...
The arm that started it, at rest.
```
